        ...
        return {
            ...
            link: function(a, f, b, c, m) {
                function v() {
                    p && (g.cancel(p), p = null);
                    l && (l.$destroy(), l = null);
                    n && (p = g.leave(n), p.done(function(a) {
                        !1 !== a && (p = null)
                    }), n = null)
                }
                ...
                function D() {
                    ...
                    if (d.isDefined(b && b.$template)) {
                        var b = a.$new(),
                            c = t.current;
                        n = m(b, function(b) {
                            g.enter(b, null, n || f).done(function(b) {
                ...
                var l, n, p, w = b.autoscroll,
                    k = b.onload || "";
                a.$on("$routeChangeSuccess", D);
                D()
            }
        }
    }
    ...
    var y,
        E, F, z = d.module("ngRoute", []).provider("$route", function() {
            ...
            this.when = function(a, f) {
                ...
                a && (c = "/" === a[a.length - 1] ? a.substr(0, a.length - 1) : a + "/", g[c] = d.extend({
                        redirectTo: a
                    },
                    u(c, b)));
                return this
            ...
            this.$get = ["$rootScope", "$location", "$routeParams", "$q", "$injector", "$templateRequest", "$sce", function(a, f, b, c, m, k, u) {
                function l(e) {
                    var h = q.current;
                    (y = (s = B()) && h && s.$$route === h.$$route && d.equals(s.pathParams, h.pathParams) && !s.reloadOnSearch && !C) || !h && !s || a.$broadcast("$routeChangeStart",
                ...
                function n() {
                    ...
                    if (y) e.params = h.params, d.copy(e.params, b), a.$broadcast("$routeUpdate", e);
                        ...
                        q.current = h;
                        var G = c.resolve(h);
                        G.then(p).then(w).then(function(c) {
                            return c && G.then(z).then(function(c) {
                ...
                function p(e) {
                    ...
                    if (e)
                        if (e.redirectTo)
                            if (d.isString(e.redirectTo)) a.path =
                                x(e.redirectTo, e.params), a.search = e.params, a.hasRedirection = !0;
                            else {
                                var b = f.path(),
                                    g = f.search();
